...
{ 
	...
	{ 
        ...
        // so now the total cost will be calculated on the basisi of no. of toppings
		System.out.println( pizza2.getDescription() + 
                        " Cost :" + pizza2.getCost()); 
        //if we add Paneer topping twice(as pers customer order)
        pizza2 =new Paneer(pizza2);
        //this adds 70 rs to cost as paneer topping cost 70rs
